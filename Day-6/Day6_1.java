...
public class Day6_1 {
	...
	public static void main(String[] arg) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//*[@id=\"input-firstname\"]")).sendKeys("Devanath");
		driver.findElement(By.xpath("//*[@id=\"input-lastname\"]")).sendKeys(" V");
		driver.findElement(By.xpath("//*[@id=\"input-email\"]")).sendKeys("deva@gmail.com");
		JavascriptExecutor js=(JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,1000)", "");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"input-password\"]")).sendKeys("Deva@123");
